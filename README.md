...
![Aiko](fleet-management-app/public/aiko.png)
...
Seu objetivo é, de posse desses dados, desenvolver o frontend de aplicação web que trate e exiba essas informações para os gestores da operação.
