...
describe('StateHistoryTable', () => {
  it('renders the state history table', () => {
    ...
    expect(cells[0]).toHaveTextContent("01/02/2021");
    expect(cells[1]).toHaveTextContent("12:00 AM");
    expect(cells[2]).toHaveTextContent("Parado");
    expect(cells[2].getAttribute("class")).toContain("text-[#f1c40f]");
    ...
    expect(cells[6]).toHaveTextContent("03/12/2023");
    expect(cells[7]).toHaveTextContent("7:00 PM");
    expect(cells[8]).toHaveTextContent("Manutenção");
    expect(cells[8].getAttribute("class")).toContain("text-[#e74c3c]");
  })
})